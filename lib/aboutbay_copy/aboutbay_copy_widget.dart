...
class AboutbayCopyWidget extends StatefulWidget {
  const AboutbayCopyWidget({
    Key key,
    this.projects,
  }) : super(key: key);

  final AddNftRecord projects;

  @override
  _AboutbayCopyWidgetState createState() => _AboutbayCopyWidgetState();
}

class _AboutbayCopyWidgetState extends State<AboutbayCopyWidget>
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<AddNftRecord>(
      future: AddNftRecord.getDocumentOnce(widget.projects.reference),
      builder: (context, snapshot) {
        ...
        final aboutbayCopyAddNftRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              aboutbayCopyAddNftRecord.titlenft,
                              style: FlutterFlowTheme.of(context).title2,
                            ),
                            Text(
                              aboutbayCopyAddNftRecord.nftPrice.toString(),
                              style:
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                aboutbayCopyAddNftRecord.description,
                                style: FlutterFlowTheme.of(context).bodyText2,
                              ),
                            ),
                          ],
