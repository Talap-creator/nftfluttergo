...
import 'schema/add_nft_record.dart';
...
export 'schema/add_nft_record.dart';
...
/// Functions to query AddNftRecords (as a Stream and as a Future).
Stream<List<AddNftRecord>> queryAddNftRecord({
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AddNftRecord.collection,
...
Future<List<AddNftRecord>> queryAddNftRecordOnce({
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<AddNftRecord>> queryAddNftRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
